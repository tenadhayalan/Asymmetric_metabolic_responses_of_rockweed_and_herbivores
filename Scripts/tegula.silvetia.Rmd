...
shell_lengths <- list(a = (tegulaSizes_new %>% filter(experiment == "a"))$shell_length_mm, b = (tegulaSizes_new %>% filter(experiment == "b"))$shell_length_mm)

overlap(shell_lengths, plot = TRUE)
...
overlap(shell_lengths_sub, plot = TRUE)
